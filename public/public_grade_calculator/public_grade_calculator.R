...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("ECON 410 Course Grade Calculator"),
...
server <- function(input, output) {
    ...
    output$printgrades <- renderText({
        coursegrade<-round(((input$disc*6)+(input$paper*0.30)+(input$midterm*0.20)+(input$final*0.2)),4)
