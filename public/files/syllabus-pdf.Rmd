...
You can find all course materials at my academic website dedicated for (all sections of) this course [devF19.classes.ryansafner.com](http://devf19.classes.ryansafner.com).
...
**You can find a full schedule** with resources for each class meeting on the [course website schedule page](http://devF19.classes.ryansafner.com/schedule/).